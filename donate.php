        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">UNICEF National Conference, Nairobi</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 28th Jan, 2021</span>
                  <span><i class="fa fa-archive"></i> <a href="#">UNICEF Kenya</a>, <a href="#">Nairobi</a></span>
                </span>
                	...
                	<div class="col-md-5">
                        <ul class="list-group">
                          <li class="list-group-item">
                      	  ...
                      	  <li class="list-group-item"> <span class="badge">Ksh 150,000,000</span> Amount Needed </li>
                      	  <li class="list-group-item"> <span class="badge">Ksh 16,000,000</span> Collected yet </li>
                ...
                <p>Derraw Adoption Agency in conjuction with UNICEF Kenya tends to hold fundraising and donation to the orphans,foster and adapted children . The target amount will be <span>Ksh 150,000,000 <span> which will be used to suport them.</p>
                <p>The raised amount will be used for education purposes and welfare support for orphans and abadoned children. Also the amount raised would be used to set up childrens' home and adoption centers.</p>
                <p> We will be expecting many guests to attend the event both from inside kenya and abroad. Our guest speaker will be Dr. Jerry Rawlings, Director of UNICEF kenya charter. Fundraising event will happen on <span>28th Jan, 2021</span> at <span>KCC, Nairobi.</span> All are welcomed.</p>
            </article>
